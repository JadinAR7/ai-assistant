...
* Trade Journal Profit Calendar tracks raw daily/monthly trading performance, including calendar-only eval/prop imports that are intentionally excluded from strategy coaching, scanner matching, pattern discovery, and future strategy-learning datasets unless promoted later.
