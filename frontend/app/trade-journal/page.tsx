      ...
      <div className="mx-auto max-w-4xl">
        <header className="mb-8 flex items-center justify-between border-b border-white/10 pb-4">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-semibold">Trade Journal</h1>
          </div>
        ...
        <section className="rounded-lg border border-amber-300/25 bg-amber-300/10 p-6">
          ...
          <p className="mt-3 text-neutral-200">
            Trade Journal is coming soon. This module will track sessions,
            reviews, rule adherence, and performance memory.
          </p>
        </section>
      </div>
    </main>
